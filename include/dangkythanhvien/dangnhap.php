...
<head>
  <meta charset="UTF-8">
  <link rel="icon" type="image/png" href="../../admin/images/login.ico">
...
<body>
  <div class="login">
    ...
    <form method="post" action="xulydangnhap.php">
    	<input type="text" name="Tentaikhoan" placeholder="Tên tài khoản" required="required" />
    ...
    <a href="dangky.php" class="btn btn-primary btn-block1 btn-large">Đăng ký</a>
  </div>
</div>
