	...
	class BinhLuan extends Db
	{
		public function show()
		{
            ...
            <hr width="50%"> 
               		...
               		<div> 
               		<a href="../admin/index2.php?mod=thaotac&ac=binhluanchuaduyet" style="margin-right: 20px; color:#333; font-weight:bold;" title="Duyệt">
					...
					<div class="tab-content default-tab" id="tab1">
							...
							foreach($show as $s)
							{
								...
								<tr>
								   ...
								   <td class="col-sm-3">
										...
										<a href="../admin/index2.php?mod=thaotac&ac=delbinhluan&mabinhluan=<?php echo $s["Mabinhluan"];?>" title="Delete" class="xoa"> <i class="fa fa-close"></i></a> 
						...
						<div style="color:#F00; clear:both; text-align:center;">
							<?php
								...
								{
									?>
									<a class="a" href="index.php?mod2=danhsachbinhluan&page=<?php echo $i;?>"><?php echo $i;?></a>&nbsp;
									<?php	
								}
							?>
						</div>
								...
								<tr>
								   ...
								   <td class="col-sm-3">
										<!-- Icons -->
										   ...
										   <a href="../admin/index2.php?mod=thaotac&ac=duyetbinhluan&mabinhluan=<?php echo $s["Mabinhluan"];?>" style="color:#666; margin-right:20px;" title="Edit">
		...
		public function duyetbinhluan()
		{
		    ...
		    window.location="index2.php?mod=danhsachbinhluan";
		    </script>
		    <?php
		}
