...
include "../class/Dangbai.class.php";
$Db = new Db();
$Db1 = new Dangbai1();
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="index3.php" class="simple-text">
                    Welcome Tác Giả <?php echo $_SESSION["tacgia"]["Mauser"]; ?>
                </a>
            </div>

            <ul class="nav">
                 <li>
                    <a href="../admin/index3.php?mod=thaotac&ac=thembai"><i class="fa fa-plus-square"></i>
                    <p>Bài Đăng</p>
                    </a>
                </li>
            </ul>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="index3.php?mod=xemthongtin&mauser=<?php echo $_SESSION["tacgia"]["Mauser"]; ?>">
                            <i class="fa fa-user"></i>Xem thông tin
                            </a>
                        </li>
                        <li>
                            <a href="index3.php?mod=suathongtin3&mauser=<?php echo $_SESSION["tacgia"]["Mauser"]; ?>">
